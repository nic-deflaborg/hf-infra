...
@description('Enable app service HTTP logging')
param AppServiceHTTPLogs bool = true

@description('Enable app service audit logging')
param AppServiceAuditLogs bool = true

@description('Enable app service app logs')
param AppServiceAppLogs bool = true
    ...
    logs: [
      {
        ...
        enabled: AppServiceHTTPLogs
      }
      {
        category: 'AppServiceAuditLogs'
        enabled: AppServiceAuditLogs
      }
      {
        category: 'AppServiceAppLogs'
        enabled: AppServiceAppLogs
      }
    ]
    metrics: [
      {
